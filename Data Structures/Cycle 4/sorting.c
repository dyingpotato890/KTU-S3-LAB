...
void resetArray(int arr[], int n) {
    int originalValues[] = {16, 24, 79, 21, 4};  
    for (int i = 0; i < n; i++)
...
void main() {
    ...
    while (menuFlag != 0) {
        ...
        scanf("%d", & o);
        switch (o) {
            case 1: bubbleSort(arr); resetArray(arr, n); break;
            case 2: insertionSort(arr); resetArray(arr, n); break;
            case 3: selectionSort(arr); resetArray(arr, n); break;
            case 4: quickSort(arr, 0, n - 1); display(arr); resetArray(arr, n); break;
            case 5: mergeSort(arr, 0, n - 1); display(arr); resetArray(arr, n); break;
            case 6: heapSort(arr, n); display(arr); resetArray(arr, n); break;
