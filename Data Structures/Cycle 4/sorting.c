...
void main() {
    ...
    while (menuFlag != 0) {
        ...
        scanf("%d", & o);
        switch (o) {
            case 1: bubbleSort(arr); resetArray(); break;
            case 2: insertionSort(arr); resetArray(); break;
            case 3: selectionSort(arr); resetArray(); break;
            case 4: quickSort(arr, 0, n - 1); display(arr); resetArray(); break;
            case 5: mergeSort(arr, 0, n - 1); display(arr); resetArray(); break;
            case 6: heapSort(arr, n); display(arr); resetArray(); break;
